...
def sample(parameters, char_to_ix, seed):
    ...
    seed -- Used for testing purposes. Do not worry about it.
...
#                        [23, 16, 26, 26, 24, 3, 21, 1, 7, 24, 15, 3, 25, 20, 6, 13, 10, 8, 20, 12, 2, 0]), "Wrong values"
#
#     print("\033[92mAll tests passed!\x1b[0m")
#
#
...
def optimize(X, Y, a_prev, parameters, learning_rate=0.01):
    ...
    gradients = dict([k, np.clip(v, -5, 5)] for k,v in gradients.items())
    ...
    for j in range(num_iterations):
        ...
        if j % 2000 == 0:
            ...
            for name in range(dino_names):
                ...
                seed += 1  # To get the same result (for testing purposes), increment the seed by one.
